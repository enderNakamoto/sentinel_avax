...
- Read `specs/progress.md` — confirm phase status is `in_progress` or `paused`
...
- Read `specs/architecture.md` to identify any stable patterns or decisions worth persisting to memory
